    ...
    this.server = new Server(
      {
        ...
        version: '2.1.0',  // Updated for embeddings
      },
      {
        capabilities: {
          tools: {},
...
Memories added in last 7 days: ${recentMemories.count}`,
  ...
  // ====================================================================
  // PROJECT MANAGEMENT METHODS (Unchanged from before)
  // ====================================================================
  ...
  // ====================================================================
  // CATEGORY MANAGEMENT METHODS (Unchanged from before)
  // ====================================================================
  ...
  // ====================================================================
  // STATUS AND TAG MANAGEMENT METHODS (Unchanged from before)
  // ====================================================================
  ...
  async run() {
    ...
    console.error('AI Memory MCP server v2.1.0 (with embeddings) running on stdio');
  }
}
